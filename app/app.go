...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".nillionapp")
}

// NewNillionApp returns a reference to an initialized NillionApp.
func NewNillionApp(
	logger log.Logger,
	db dbm.DB,
	...
	*/
	...
	app.ModuleManager = module.NewManager(
		...
		ica.NewAppModule(&app.ICAControllerKeeper, nil),
...
func (app *NillionApp) setAnteHandler(txConfig client.TxConfig) {
...
func (app *NillionApp) setPostHandler() {
...
func (app *NillionApp) Name() string { return app.BaseApp.Name() }

// PreBlocker application updates every pre block
func (app *NillionApp) PreBlocker(ctx sdk.Context, _ *abci.RequestFinalizeBlock) (*sdk.ResponsePreBlock, error) {
...
func (app *NillionApp) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
	return app.ModuleManager.EndBlock(ctx)
}

// Configurator returns the configurator for the app
func (app *NillionApp) Configurator() module.Configurator {
	return app.configurator
}

// InitChainer application update at chain initialization
func (app *NillionApp) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
...
func (app *NillionApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// LegacyAmino returns NillionApp's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *NillionApp) LegacyAmino() *codec.LegacyAmino {
	return app.legacyAmino
}

// AppCodec returns NillionApp's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *NillionApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns NillionApp's InterfaceRegistry
func (app *NillionApp) InterfaceRegistry() types.InterfaceRegistry {
	return app.interfaceRegistry
}

// TxConfig returns NillionApp's TxConfig
func (app *NillionApp) TxConfig() client.TxConfig {
	return app.txConfig
}
...
func (app *NillionApp) DefaultGenesis() map[string]json.RawMessage {
...
func (app *NillionApp) GetKey(storeKey string) *storetypes.KVStoreKey {
	return app.keys[storeKey]
}

// GetStoreKeys returns all the stored store keys.
func (app *NillionApp) GetStoreKeys() []storetypes.StoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *NillionApp) GetSubspace(moduleName string) paramstypes.Subspace {
	subspace, _ := app.ParamsKeeper.GetSubspace(moduleName)
	return subspace
}

// SimulationManager implements the SimulationApp interface
func (app *NillionApp) SimulationManager() *module.SimulationManager {
	return app.simulationManager
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *NillionApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *NillionApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *NillionApp) RegisterTendermintService(clientCtx client.Context) {
...
func (app *NillionApp) RegisterNodeService(clientCtx client.Context, cfg config.Config) {
...
func (app *NillionApp) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeper implements the TestingApp interface.
func (app *NillionApp) GetStakingKeeper() ibctestingtypes.StakingKeeper {
	return app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *NillionApp) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

// GetTxConfig implements the TestingApp interface.
func (app *NillionApp) GetTxConfig() client.TxConfig {
	return app.txConfig
}
...
func (app *NillionApp) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
